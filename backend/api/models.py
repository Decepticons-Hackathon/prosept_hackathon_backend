...
class Product(models.Model):
    ...
    min_rec_price = models.FloatField(null=True, blank=True)
...
class DealerProduct(models.Model):
    key = models.ManyToManyField(DealerPrice)
...
class DealerProductVariants(models.Model):
    dealer_product_id = models.ForeignKey(DealerProduct, on_delete=models.CASCADE)

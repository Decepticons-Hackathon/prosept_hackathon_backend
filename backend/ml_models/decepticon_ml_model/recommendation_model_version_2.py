...
class RecommendationModel:
    def __init__(self, product_data):
        ...
        self.pickle_model_path = os.path.join(os.path.dirname(__file__), 'pickle_model_version_2.pkl')
        with open(self.pickle_model_path, "rb") as file:
    ...
    def result(self, parser_data, n_matchs=5):
        ...
        df.drop(['name', 'product_name', 'id', 'product_mera_let', 'mera_let'], axis=1, inplace=True)

...
url_list = [
    ...
    path('dealers-stat/', views.DealersStat.as_view(), name='dealers_stat'),
    path('match-stat/', views.MLStat.as_view(), name='ml_stat'),
    ...
    path('references/', views.AppDicts.as_view(), name='references'),
